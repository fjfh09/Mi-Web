...
try {
    ...
    $sql = "SELECT id, nombre, apellidos, correo, usuario, fecha_registro, activo FROM cliente ORDER BY fecha_registro DESC";
    $stmt = $conn->query($sql);
...
<head>
    ...
    <title>Usuarios | AlmagaraVPN</title>
    <style>
        * {
                ...
                <?php if ($usuarios): ?>
                    <?php foreach ($usuarios as $usuario): ?>
                        <tr>
                            ...
                            <td class="<?= $usuario['activo'] ? 'activo' : 'inactivo' ?>">
                                <?= $usuario['activo'] ? 'Sí' : 'No' ?>
                            </td>            
                            <td>
                                <a href="editar_usuario.php?id=<?= $usuario['id'] ?>" class="btn">Editar</a>
<a href="borrar_usuario.php?id=<?= $usuario['id'] ?>" class="btn btn-danger" onclick="return confirm('¿Seguro que quieres borrar este usuario? Esta acción no se puede deshacer.');">Borrar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
